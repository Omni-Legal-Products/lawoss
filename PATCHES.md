...
| `apps/app/src/app/index.css` | +2 `@import` lines (LAWOSS token + font override after upstream tokens); `--chart-1..5` values remapped to brand palette | Fáza A reskin via cascade, zero structural change | MČ | design/faza-a-tokeny |
