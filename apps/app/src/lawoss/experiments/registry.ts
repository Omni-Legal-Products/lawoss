...
export const EXPERIMENTS: readonly Experiment[] = [
  ...
  },
  {
    ...
    to: "/prehlad",
    label: "Prehľad",
    note: "Denný prehľad praxe — číta pamäť spisov z workspace-u (AK/…/Spisy/…/memory), bez zápisu; bez spisov ukáže označenú ukážku.",
    owner: "MČ",
    stav: "v testovaní",
  },
  {
    ...
    to: "/lehoty",
    label: "Lehoty",
    note: "Register lehôt zo záznamov pamäte spisov — zobrazuje zapísaný dátum, bez výpočtu a bez zápisu; SK a CZ sa modelujú zvlášť.",
    owner: "MČ",
    stav: "v testovaní",
  },
  {
