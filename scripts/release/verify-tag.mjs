...
check("legalwork-orchestrator", orchestratorVersion);
check("legalwork-server", serverVersion);
...
console.log(`Release tag ${tag} matches app/desktop/legalwork-orchestrator versions.`);
